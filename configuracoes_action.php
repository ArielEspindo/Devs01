    ...
    if(!empty($password)) {
        ...
        if(isset($_FILES['avatar']) && !empty($_FILES['avatar']['tmp_name'])) {
            ...
            if(in_array($newAvatar['type'], ['image/jpeg', 'image/jpg', 'image/png'])) {
                ...
                $x = $avatarWeight - $newWidth;
                $y = $avatarHeight - $newHeight;
                $x = $x<0 ? $x/2 : $x;
                $y = $y<0 ? $y/2 : $y;

                $finalImage = imagecreatetruecolor($avatarWeight, $avatarHeight);
        ...
        if(isset($_FILES['cover']) && !empty($_FILES['cover']['tmp_name'])) {
            ...
            if(in_array($newCover['type'], ['image/jpeg', 'image/jpg', 'image/png'])) {
                ...
                $x = $coverWeight - $newWidth;
                $y = $coverHeight - $newHeight;
                $x = $x<0 ? $x/2 : $x;
                $y = $y<0 ? $y/2 : $y;

                $finalImage = imagecreatetruecolor($coverWeight, $coverHeight);
